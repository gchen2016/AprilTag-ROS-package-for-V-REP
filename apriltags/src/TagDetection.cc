...
double TagDetection::getYawValue(Eigen::Quaternion<double> &inputQuat) const {
  double q1 = inputQuat.x();
  double q2 = inputQuat.y();
  double q3 = inputQuat.z();
  double q0 = inputQuat.w();
